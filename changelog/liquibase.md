...
-- superuser run from cli
liquibase --username=salmansheikh updateSQL   # preview (optional but recommended)
liquibase --username=salmansheikh update       # actually run it
